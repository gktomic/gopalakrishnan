...
export function Portfolio() {
    return <div>
        ...
        <div className="mt-5 flex flex-row justify-center items-center flex-wrap gap-10">
            <Card title="Employee Portal" description="Full stack employee portal application tested with multi line description." thumbnail={employeeportal_thumbnail} codelink="https://github.com/gopalakrishnanpv/sern-employee-portal" />
