...
export function Portfolio() {
    return <div id="portfolioSection">
        ...
        <div className="mt-5 flex flex-row justify-center items-stretch flex-wrap gap-10">
            ...
            <Card title="Autobot" description="Most versatile practice website with various html elements for test automation." thumbnail_path="/images/thumbnail_auto-bot.png" codelink="https://github.com/gopalakrishnanpv/autobot" demolink="https://auto-bot-demo.vercel.app" />
        </div>
    </div >
}