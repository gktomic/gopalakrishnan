...
export function Achievements() {
    ...
    return <div id="achievementsSection">
        ...
        <ul className="mt-5 text-white">
            <Achievement description="Developed TAFManager, a full stack application in Vue 3 and python for test design." />
            <Achievement description="Received Well Done Champ award for concurrent testing implementation." />
