...
export function Achievements() {
    return <div>
        <h1 className="mt-10 text-3xl font-medium uppercase text-white py-5 text-center underline underline-offset-[16px] decoration-4 decoration-dotted decoration-sky-500">Achievements</h1>
        <ul className="mt-5">
